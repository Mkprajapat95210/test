...
interface ProductGridProps {
  products: Array<Omit<React.ComponentProps<typeof ProductItem>, 'boxShadow' | 'overlayNone' | 'showDownloadBtn' | 'maxHUnset'>>;
}
...
const newArrivalProductsData = [
  ...
  {
    imageSrc: 'assets/images/thumbs/product-img5.png',
    title: 'SaaS dashboard digital products Title here',
    author: 'themepix',
    price: '$99',
    prevPrice: '$129',
  ...
  {
    imageSrc: 'assets/images/thumbs/product-img6.png',
    title: 'SaaS dashboard digital products Title here',
    author: 'themepix',
    price: '$129',
    prevPrice: '$256',
  ...
  {
    imageSrc: 'assets/images/thumbs/product-img7.png',
    title: 'SaaS dashboard digital products Title here',
    author: 'themepix',
    price: '$129',
    prevPrice: '$259',
  ...
  {
    imageSrc: 'assets/images/thumbs/product-img8.png',
    title: 'SaaS dashboard digital products Title here',
    author: 'themepix',
    price: '$79',
    prevPrice: '$99',
      ...
      <div className="container container-two">
        ...
        <div className="tab-content" id="pills-tabContent">
          <div className="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab" tabIndex={0}>
            <ProductGrid products={newArrivalProductsData} />
          </div>
