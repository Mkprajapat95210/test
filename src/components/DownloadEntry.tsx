...
export const DownloadEntry: React.FC<DownloadEntryProps> = ({
  imgSrc, title, licenseType, checkboxId
}) => (
  <div className="download-item flx-between gap-3">
    <div className="download-item__content flx-align flex-nowrap gap-3 flex-grow-1">
      ...
      <div className="download-item__info">
        ...
        <a href="#" className="download-item__text text-main mb-3 font-12 hover-text-decoration-underline">{licenseType}</a>
