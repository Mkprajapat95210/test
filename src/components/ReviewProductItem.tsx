...
export const ReviewProductItem: React.FC<ReviewProductItemProps> = ({
  imgSrc, productName, date, userName, userComment
}) => (
  <tr>
    <td>
      <div className="review-product d-flex align-items-center gap-2">
        ...
        <div className="review-product__content">
          ...
          <span className="review-product__date font-12">{date}</span>
        </div>
      </div>
    </td>
    <td>
