  ...
  return (
    <div className="product-details">
      ...
      <div className="product-details__buttons flx-align justify-content-center gap-3">
        ...
        <a href="#" className="screenshot-btn btn btn-white pill px-sm-5" data-images='["assets/images/thumbs/product-details.png", "assets/images/thumbs/product-details.png"]'>Screenshot</a>
      </div>
      ...
      <div className="more-item">
        <div className="flx-between mb-4">
          ...
          <a href="profile.html" className="text-heading fw-500 hover-text-decoration-underline">View Author Profile</a>
        </div>
        <div className="more-item__content flx-align">
          <div className="more-item__item">
            <a href="all-product.html" className="link w-100 h-100 d-block">
